...
4. Compilar imagen en máquina host:
    ...
    $ docker build -t RG350_buildroot_image .
    ```

5. Arrancar contenedor:

    ```
    $ docker run -it -v ~/git/RG350_buildroot:/root/RG350_buildroot --name RG350_buildroot_container RG350_buildroot_image
    ```
...
```
$ docker start RG350_buildroot_container
$ docker exec -it RG350_buildroot_container /bin/bash
```
